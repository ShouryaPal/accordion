...
function BackgroundImage() {
  return (
    <div className="w-full h-auto absolute top-0 left-0">
      <Image src={desktopbg} alt="desktop-bg" className="w-full h-full object-cover hidden md:block" />
      <Image src={mobilebg} alt="mobile-bg" className="w-full h-full object-cover md:hidden" />
    </div>
  )
}